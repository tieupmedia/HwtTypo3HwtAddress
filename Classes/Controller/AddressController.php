...
class AddressController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController
{
    ...
    public function listAction(): ResponseInterface
    {
        ...
        } elseif ((isset($this->settings['addressCategories']) && $this->settings['addressCategories'])
                  || $zip) {
        ...
        if ((count($addressRecords) == 0) && isset($this->settings['addressRecords']) && $this->settings['addressRecords']) {
